<template>
	<!-- clounds -->
	<div v-if="currentWeather == 'Clouds'">
	<svg class="overcast-clouds" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 82.6 	52.3" style="enable-background:new 0 0 82.6 52.3;" xml:space="preserve">
			...
			c-1.4-4.4-5.5-6.9-9.9-7.4c-3.4-0.4-6.6,0.8-9,3.2c-0.1,0.1-1.2,1.3-1.2,1.3S25.3,23.6,21.8,24.2z"></path>
			...
			c-1.8-1.2-3.9-1.9-6.2-1.9c-5.5,0-10,4-10.8,9.3c-3.5,1-6.1,3.9-6.6,7.6h26.3h12.7h12.9h0.7C57.6,41.8,57.6,41.4,57.6,40.7z"></path>
			</g>
		<g id="Layer_2">
		</g>
	</svg>
	...
	<!-- sun -->
	<div v-else-if="currentWeather == 'Clear'">
		<svg version="1.1" class="clear-sky-svg" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 72.3 52.6" style="enable-background:new 0 0 72.3 52.6;" xml:space="preserve">
			<g>
				<path class="sun-icon" d="M50.8,25.7c0,7.9-6.4,14.4-14.4,14.4s-14.4-6.4-14.4-14.4s6.4-14.4,14.4-14.4S50.8,17.8,50.8,25.7z"></path>
	...
	<!-- snow -->
	<div v-else-if="currentWeather == 'Snow'">
	...
	<path class="cloud" d="M63.9,30.9c0-5.2-4.2-9.4-9.4-9.4c-0.2,0-0.4,0.1-0.7,0.1c-0.1-0.9-0.2-1.8-0.5-2.7c-0.3-1.1-0.9-2.2-1.5-3.1
		...
		c-1.9-1.3-4.2-2.1-6.7-2.1c-6,0-10.9,4.4-11.8,10.1c-3.8,1.1-6.7,4.3-7.2,8.3h28.7h13.9H63h0.8C63.9,32.1,63.9,31.7,63.9,30.9z"></path>
	<g class="snowflake">
		<line class="snowflake-path big-path" x1="10.3" y1="37" x2="10.3" y2="43.5"></line>
		<line class="snowflake-path big-path" x1="13.5" y1="40.3" x2="7" y2="40.3"></line>
		<g>
			<line class="snowflake-path big-path" x1="12.6" y1="38" x2="8" y2="42.6"></line>
			<line class="snowflake-path big-path" x1="12.6" y1="42.6" x2="8" y2="38"></line>
		</g>
	</g>
	<g class="snowflake">
		<line class="snowflake-path big-path" x1="22.7" y1="37" x2="22.7" y2="43.5"></line>
		<line class="snowflake-path big-path" x1="25.9" y1="40.3" x2="19.4" y2="40.3"></line>
		<g>
			<line class="snowflake-path big-path" x1="25" y1="38" x2="20.4" y2="42.6"></line>
			<line class="snowflake-path big-path" x1="25" y1="42.6" x2="20.4" y2="38"></line>
		</g>
	</g>
	<g class="snowflake">
		<line class="snowflake-path big-path" x1="35.2" y1="37" x2="35.2" y2="43.5"></line>
		<line class="snowflake-path big-path" x1="38.4" y1="40.3" x2="31.9" y2="40.3"></line>
		<g>
			<line class="snowflake-path big-path" x1="37.5" y1="38" x2="32.9" y2="42.6"></line>
			<line class="snowflake-path big-path" x1="37.5" y1="42.6" x2="32.9" y2="38"></line>
		</g>
	</g>
	<g class="snowflake">
		<line class="snowflake-path big-path" x1="48.3" y1="37" x2="48.3" y2="43.5"></line>
		<line class="snowflake-path big-path" x1="51.6" y1="40.3" x2="45" y2="40.3"></line>
		<g>
			<line class="snowflake-path big-path" x1="50.6" y1="38" x2="46" y2="42.6"></line>
			<line class="snowflake-path big-path" x1="50.6" y1="42.6" x2="46" y2="38"></line>
		</g>
	</g>
	<g class="snowflake">
		<line class="snowflake-path big-path" x1="60.5" y1="37" x2="60.5" y2="43.5"></line>
		<line class="snowflake-path big-path" x1="63.7" y1="40.3" x2="57.2" y2="40.3"></line>
		<g>
			<line class="snowflake-path big-path" x1="62.8" y1="38" x2="58.2" y2="42.6"></line>
			<line class="snowflake-path big-path" x1="62.8" y1="42.6" x2="58.2" y2="38"></line>
		</g>
	</g>
    <g class="snowflake">
        <line class="snowflake-path big-path" x1="10.3" y1="37" x2="10.3" y2="43.5"></line>
	...
	<!-- hurricane -->
	<div v-else-if="currentWeather == 'Rain'">
	...
	<!-- wind -->
	<div v-else-if="currentWeather == 'Wind'">
...
<g id="Layer_1_1_">
	...
	<!-- fog -->
	<div v-else-if="currentWeather == 'Fog' || 'mist'">
		...
		<g id="Layer_1">
			<g>
				...
				c-1.9-1.3-4.2-2.1-6.7-2.1c-6,0-10.9,4.4-11.8,10.1c-3.8,1.1-6.7,4.3-7.2,8.3h28.7h13.9h14.1h0.8C62.7,30.6,62.8,30.1,62.8,29.3z"></path>
			<path class="fog-line big-path" d="M7.3,28.8h12.4"></path>
			<path class="fog-line big-path" d="M23.5,28.8h38.4"></path>
			<path class="fog-line big-path" d="M57.3,32.6h5.2"></path>
			<path class="fog-line big-path" d="M31.2,32.6h22.1"></path>
			<path class="fog-line big-path" d="M6.2,32.6h21.1"></path>
			<path class="fog-line big-path" d="M11.4,43.6H6.2"></path>
			<path class="fog-line big-path" d="M37.5,43.6H15.4"></path>
			<path class="fog-line big-path" d="M62.5,43.6H41.4"></path>
			<path class="fog-line big-path" d="M6.2,36.4h2.1"></path>
			<path class="fog-line big-path" d="M11.9,36.4h6"></path>
			<path class="fog-line big-path" d="M21.8,36.4h20.4"></path>
			<path class="fog-line big-path" d="M46.3,36.4h16.1"></path>
			<path class="fog-line big-path" d="M55.2,40.2h7.3"></path>
			<path class="fog-line big-path" d="M48.3,40.2h2.8"></path>
			<path class="fog-line big-path" d="M37.3,40.2H44"></path>
			<path class="fog-line big-path" d="M18.3,40.2h15.3"></path>
			<path class="fog-line big-path" d="M6.2,40.2h8"></path>
			</g>
		</g>
